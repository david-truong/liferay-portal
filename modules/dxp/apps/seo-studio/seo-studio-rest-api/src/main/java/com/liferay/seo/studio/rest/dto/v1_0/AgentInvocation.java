 ...
 */
@Generated("")
@GraphQLName("AgentInvocation")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "AgentInvocation")
public class AgentInvocation implements Serializable {

	public static AgentInvocation toDTO(String json) {
		return ObjectMapperUtil.readValue(AgentInvocation.class, json);
	}

	public static AgentInvocation unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(AgentInvocation.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof AgentInvocation)) {
			return false;
		}

		AgentInvocation agentInvocation = (AgentInvocation)object;

		return Objects.equals(toString(), agentInvocation.toString());
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.seo.studio.rest.dto.v1_0.AgentInvocation",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1871525407