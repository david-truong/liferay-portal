 ...
 */
@Generated("")
public class AgentInvocation implements Cloneable, Serializable {

	public static AgentInvocation toDTO(String json) {
		return AgentInvocationSerDes.toDTO(json);
	}
	...
	@Override
	public AgentInvocation clone() throws CloneNotSupportedException {
		return (AgentInvocation)super.clone();
	}
	...
	public String toString() {
		return AgentInvocationSerDes.toJSON(this);
	}

}
// LIFERAY-REST-BUILDER-HASH:-398642862