...
public class LayoutCTEntryModelListener extends BaseModelListener<CTEntry> {
			...
			if (_log.isWarnEnabled()) {
				_log.warn(
					StringBundler.concat(
						"Unable to update displaying layouts for model class ",
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LayoutCTEntryModelListener.class);
