...
public class
	AddToLaunchJournalArticleContentDashboardItemVersionActionProviderTest {
	...
	@Inject(
		filter = "component.name=com.liferay.content.dashboard.journal.internal.item.action.provider.AddToLaunchJournalArticleContentDashboardItemVersionActionProvider"
	)
