...
import com.liferay.content.dashboard.journal.internal.item.action.AddToLaunchJournalArticleContentDashboardItemVersionAction;
...
public class AddToLaunchJournalArticleContentDashboardItemVersionActionProvider
	...
	public ContentDashboardItemVersionAction
		...
		return new AddToLaunchJournalArticleContentDashboardItemVersionAction(
	...
	public boolean isShow(
		...
		if ((journalArticle.getStatus() != WorkflowConstants.STATUS_APPROVED) ||
			!FeatureFlagManagerUtil.isEnabled(
				journalArticle.getCompanyId(), "LPD-72278")) {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddToLaunchJournalArticleContentDashboardItemVersionActionProvider.
			class);
