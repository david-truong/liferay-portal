...
public class EmailOTPEntryLocalServiceWrapper
	...
	@Override
	public com.liferay.multi.factor.authentication.checker.email.otp.model.
		EmailOTPEntry fetchEmailOTPEntry(long userId, String mfaCheckerName) {

		return _emailOTPEntryLocalService.fetchEmailOTPEntry(
	...
	public java.util.List
		<com.liferay.multi.factor.authentication.checker.email.otp.model.
			EmailOTPEntry> getEmailOTPEntriesByMFACheckerName(
		...
		return _emailOTPEntryLocalService.getEmailOTPEntriesByMFACheckerName(
	...
	public boolean updateFailedAttempt(
		...
		return _emailOTPEntryLocalService.updateFailedAttempt(
	...
	public boolean updateSuccessAttempt(
		...
		return _emailOTPEntryLocalService.updateSuccessAttempt(
			mfaCheckerName, userId, userIP);
	}
