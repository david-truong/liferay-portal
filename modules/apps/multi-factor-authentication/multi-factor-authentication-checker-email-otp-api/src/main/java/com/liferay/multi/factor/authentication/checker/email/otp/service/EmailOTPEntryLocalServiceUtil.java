...
public class EmailOTPEntryLocalServiceUtil {
	...
	public static
		...
		return getService().addEmailOTPEntry(
	...
	public static
		com.liferay.multi.factor.authentication.checker.email.otp.model.
			EmailOTPEntry fetchEmailOTPEntry(
				long userId, String mfaCheckerName) {

		return getService().fetchEmailOTPEntry(userId, mfaCheckerName);
	}
	...
	public static java.util.List
		...
		return getService().getEmailOTPEntriesByMFACheckerName(
