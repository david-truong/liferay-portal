...
/**
 * Provides the local service utility for TimebasedOTPEntry. This utility wraps
 * <code>com.liferay.multi.factor.authentication.checker.timebased.otp.service.impl.TimebasedOTPEntryLocalServiceImpl</code> and
 ...
 */
@ProviderType
public class TimebasedOTPEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.multi.factor.authentication.checker.timebased.otp.service.impl.TimebasedOTPEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static
		...
		return getService().addTimebasedOTPEntry(
	...
	public static
		com.liferay.multi.factor.authentication.checker.timebased.otp.model.
			TimebasedOTPEntry addTimebasedOTPEntry(
				com.liferay.multi.factor.authentication.checker.timebased.otp.
					model.TimebasedOTPEntry timebasedOTPEntry) {

		return getService().addTimebasedOTPEntry(timebasedOTPEntry);
	}
	...
	public static
		...
		return getService().createTimebasedOTPEntry(entryId);
	}
	...
	public static
		...
		return getService().deleteTimebasedOTPEntry(entryId);
	}
	...
	public static
		...
		return getService().deleteTimebasedOTPEntry(timebasedOTPEntry);
	}
	...
	public static
		...
		return getService().fetchTimebasedOTPEntry(entryId);
	}
	...
	public static java.util.List
		...
		return getService().geTimebasedOTPEntriesByMFACheckerName(
	...
	public static java.util.List
		...
		return getService().getTimebasedOTPEntries(start, end);
	}
	...
	public static java.util.List
		...
		return getService().getTimebasedOTPEntriesByUserId(
	 ...
	 */
	public static int getTimebasedOTPEntriesCount() {
		return getService().getTimebasedOTPEntriesCount();
	}
	...
	public static
		...
		return getService().getTimebasedOTPEntry(entryId);
	}
	...
	public static
		...
		return getService().updateTimebasedOTPEntry(timebasedOTPEntry);
	}

	public static TimebasedOTPEntryLocalService getService() {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			TimebasedOTPEntryLocalService.class);

		ServiceTracker
			<TimebasedOTPEntryLocalService, TimebasedOTPEntryLocalService>
				serviceTracker =
					new ServiceTracker
						<TimebasedOTPEntryLocalService,
						 TimebasedOTPEntryLocalService>(
							 bundle.getBundleContext(),
							 TimebasedOTPEntryLocalService.class, null);
