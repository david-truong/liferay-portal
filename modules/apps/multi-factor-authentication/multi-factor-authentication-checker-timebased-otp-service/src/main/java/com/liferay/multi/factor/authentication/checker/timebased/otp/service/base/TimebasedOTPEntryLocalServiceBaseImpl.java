...
package com.liferay.multi.factor.authentication.checker.timebased.otp.service.base;
...
/**
 * Provides the base implementation for the timebased otp entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.multi.factor.authentication.checker.timebased.otp.service.impl.TimebasedOTPEntryLocalServiceImpl}.
 * </p>
 *
 * @author arthurchan35
 * @see com.liferay.multi.factor.authentication.checker.timebased.otp.service.impl.TimebasedOTPEntryLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class TimebasedOTPEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements TimebasedOTPEntryLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TimebasedOTPEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.multi.factor.authentication.checker.timebased.otp.service.TimebasedOTPEntryLocalServiceUtil</code>.
	 */
	...
	public TimebasedOTPEntry addTimebasedOTPEntry(
		...
		return timebasedOTPEntryPersistence.update(timebasedOTPEntry);
	}
	...
	public TimebasedOTPEntry createTimebasedOTPEntry(long entryId) {
		return timebasedOTPEntryPersistence.create(entryId);
	}
	...
	public TimebasedOTPEntry deleteTimebasedOTPEntry(long entryId)
		...
		return timebasedOTPEntryPersistence.remove(entryId);
	}
	...
	public TimebasedOTPEntry deleteTimebasedOTPEntry(
		...
		return timebasedOTPEntryPersistence.remove(timebasedOTPEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TimebasedOTPEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return timebasedOTPEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return timebasedOTPEntryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return timebasedOTPEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return timebasedOTPEntryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TimebasedOTPEntry fetchTimebasedOTPEntry(long entryId) {
		return timebasedOTPEntryPersistence.fetchByPrimaryKey(entryId);
	}
	...
	public TimebasedOTPEntry getTimebasedOTPEntry(long entryId)
		...
		return timebasedOTPEntryPersistence.findByPrimaryKey(entryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TimebasedOTPEntry.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TimebasedOTPEntry.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return timebasedOTPEntryLocalService.deleteTimebasedOTPEntry(
			(TimebasedOTPEntry)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return timebasedOTPEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TimebasedOTPEntry> getTimebasedOTPEntries(int start, int end) {
		return timebasedOTPEntryPersistence.findAll(start, end);
	}
	...
	public int getTimebasedOTPEntriesCount() {
		return timebasedOTPEntryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TimebasedOTPEntryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		timebasedOTPEntryLocalService = (TimebasedOTPEntryLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TimebasedOTPEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				timebasedOTPEntryPersistence.getDataSource();
	...
	protected TimebasedOTPEntryLocalService timebasedOTPEntryLocalService;

	@Reference
	protected TimebasedOTPEntryPersistence timebasedOTPEntryPersistence;
