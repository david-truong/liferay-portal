...
public class EmailOTPEntryModelImpl
	...
	static {
		...
		attributeSetterBiConsumers.put(
			"mfaCheckerName",
			(BiConsumer<EmailOTPEntry, String>)
				EmailOTPEntry::setMfaCheckerName);
	...
	public Object clone() {
		...
		emailOTPEntryImpl.setMfaCheckerName(getMfaCheckerName());
	...
	public void resetOriginalValues() {
		...
		emailOTPEntryModelImpl._originalMfaCheckerName =
			emailOTPEntryModelImpl._mfaCheckerName;
	...
	public CacheModel<EmailOTPEntry> toCacheModel() {
		...
		emailOTPEntryCacheModel.mfaCheckerName = getMfaCheckerName();

		String mfaCheckerName = emailOTPEntryCacheModel.mfaCheckerName;

		if ((mfaCheckerName != null) && (mfaCheckerName.length() == 0)) {
			emailOTPEntryCacheModel.mfaCheckerName = null;
		}
